...
public class SensorDAOImpl implements SensorDAO {
	...
	public boolean create(Sensor sensor) {
		...
		try {
			...
			Query query = session.createSQLQuery("INSERT INTO Sensor (SensorID, Name, CreatedAt, CreatedBy, Status, StreamID, Members, Instrument, Description) VALUES (:sensorID, :name, :createdAt, :createdBy, :status, :streamID, :members, :instrument, :description) ");
			...
			query.setParameter("instrument", sensor.getInstrument());
