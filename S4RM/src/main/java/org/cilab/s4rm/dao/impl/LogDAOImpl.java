...
public class LogDAOImpl implements LogDAO {
	...
	public PersistenceLog read(int logID) {
		return (PersistenceLog)this.sessionFactory.getCurrentSession().get(PersistenceLog.class, logID);
	}
	...
	public List<PersistenceLog> list() {
		...
		List<PersistenceLog> logList = (List<PersistenceLog>) sessionFactory.getCurrentSession().createCriteria(PersistenceLog.class)
	...
	public PersistenceLog getByUniqueKey(String startTime, String streamID) {
		...
		PersistenceLog log = (PersistenceLog) query.uniqueResult();
		return log;
	}
...
//		
		...
		@SuppressWarnings("unchecked")
		List<PersistenceLog> logList = (List<PersistenceLog>) query.list();
		return logList;
	}
